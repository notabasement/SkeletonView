...
class SkeletonMultilineLayerBuilder {
    ...
    func build() -> CALayer? {
        ...
        layer.updateLayerFrame(for: index, size: CGSize(width: width, height: height), multilineSpacing: self.multilineSpacing, paddingInsets: paddingInsets, alignment: alignment)
